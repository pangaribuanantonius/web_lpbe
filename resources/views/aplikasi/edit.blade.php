                    ...
                    <input type="hidden" name="id">
                          <!--   <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_unit" class="form-control" value="{{ $aplikasi->nama_unit }}" required><br />
                            </div>
                            <div class="form-group">
                                <label>Nama Aplikasi</label>
                                <input type="text" name="nama_aplikasi" class="form-control" value="{{ $aplikasi->nama_aplikasi }}" required><br />
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="platform" class="form-control" value="{{ $aplikasi->Platform }}" placeholder="Masukkan Plarform lainnya jika ada"><br />
                            </div>
                            <div class="form-group">
                                <label>URL</label>
                                <input type="text" name="url" class="form-control" placeholder="Masukkan Alamat URL jika Ada" value="{{ $aplikasi->url }}"><br />
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" name="informasi" class="form-control" value="{{ $aplikasi->informasi }}" required></textarea><br />
                            </div>
                            <div class="form-group">
                                <label>Dasar Hukum</label>
                                <textarea type="text" name="dasarhukum" class="form-control" value="{{ $aplikasi->dasarhukum }}" required></textarea><br />
                            </div>
                            <div class="form-group">
                                ...
                                <select name="sektorpelayananpublik" id="sektorpelayananpublik" class="form-control" required>
                                    <option value="{{ $aplikasi->nama_unit }}">{{ $aplikasi->nama_unit }}</option>
                            ...
                            <div id="nama" class="form-group" style="display:none;">
                                ...
                                <input type="text" name="sektorpelayananpublik2" class="form-control" value="{{ $aplikasi->sektorpelayananpublik2 }}" placeholder="Masukkan Disini">
                            </div>
                        ...
                        <br />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" name="deskripsi" class="form-control" value="{{ $aplikasi->deskripsi }}" required></textarea><br />
                                    </div>
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                       ...
                                       <select name="pengguna" id="pengguna" class="form-control" required>
                                            <option value="{{ $aplikasi->pengguna }}">{{ $aplikasi->pengguna }}</option>
                                    ...
                                    <div id="masukkan" class="form-group" style="display:none;">
                                        ...
                                        <input type="text" name="pengguna2" class="form-control" value="{{ $aplikasi->pengguna2 }}" placeholder="Masukkan Disini">
                                    </div>
                                ...
                                <br />
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="daftarlayanan" class="form-control" value="{{ $aplikasi->daftarlayanan }}" required><br />
                                    </div>
                                    <div class="form-group">
                                        <label>Daftar Produk Layanan</label>
                                        <input type="text" name="daftarproduklayanan" class="form-control" value="{{ $aplikasi->daftarproduklayanan }}" required><br />
                                    </div>
                                    <div class="form-group">
                                        <label>Tanggal Launching</label>
                                        <input type="date" name="launching" class="form-control" value="{{ $aplikasi->launching }}" required><br />
                                    </div>
                                    <div class="form-group">
                                        <label>Penanggung Jawab</label>
                                        <input type="text" name="penanggungjawab" class="form-control" value="{{ $aplikasi->penanggungjawab }}" required><br />
                                    </div>
                                    <div class="form-group">
                                        <label>Kontak</label>
                                        <input type="text" name="kontak" class="form-control" value="{{ $aplikasi->kontak }}" required><br />
                                    </div>
                                    <!-- <div class="form-group">
                                        <label>Tahun</label>
